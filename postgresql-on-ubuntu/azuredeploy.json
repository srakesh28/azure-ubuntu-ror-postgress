{
  ...
  "variables": {
    "templateBaseUrl": "https://raw.githubusercontent.com/srakesh28/azure-ubuntu-ror-postgress/master/postgresql-on-ubuntu/",
  ...
  "resources": [
    {
      ...
      "properties": {
        ...
        "parameters": {
		  ...
		  "webavailabilitySetSettings": {
            "value": "[variables('webavailabilitySetSettings')]"
          }
        }
      }
    },
    ...
    },
    {
      ...
      "properties": {
        ...
        "parameters": {
		 ...
		 "machineSettings": {
            "value": {
            "availabilitySet": "[variables('webavailabilitySetSettings').name]"
            }
          }
        }
      }
